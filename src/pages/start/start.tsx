  ...
  return (
    <div className="min-h-screen bg-elevenlabs-dark text-white flex flex-col md:flex-row">
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-8 md:p-12">
        ...
        <div className="w-full max-w-xs my-8 h-px bg-elevenlabs-green/60" aria-hidden />

        <div className="flex flex-col sm:flex-row items-center justify-center gap-10">
          <Link
            to="/training"
            className="inline-flex items-center gap-3 rounded-xl px-8 py-4 text-lg font-medium no-underline
              border-2 border-elevenlabs-green text-elevenlabs-green bg-transparent
              transition-all duration-200 hover:scale-[1.02] hover:shadow-lg hover:bg-elevenlabs-green/10"
          >
            <span>Training</span>
      ...
      <div className="flex flex-1 flex-col items-center justify-center p-8 md:p-12 border-t md:border-t-0 md:border-l border-elevenlabs-border overflow-hidden">
        <div className="flex flex-col items-center w-full max-w-md">
          <h2 className="text-xl font-semibold text-white mb-1 text-center pb-1 border-b-[3px] border-elevenlabs-green inline-block">
            Scenarios
          </h2>
          ...
          <div className="flex flex-col gap-5 w-full overflow-y-auto scrollbar-thin max-h-[50vh] pr-1">
            {scenarios.map((scenario, index) => (
              <div
                ...
                className={`rounded-xl border p-4 transition-colors hover:border-elevenlabs-green ${
                  scenario.title
                ...
                {scenario.title ? (
                  <>
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="flex items-center justify-center w-6 h-6 rounded-full text-xs font-semibold bg-elevenlabs-green/20 text-elevenlabs-green">
                        {index + 1}
                      </span>
